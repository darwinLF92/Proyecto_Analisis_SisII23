...
<div id="receipt_wrapper">
	<div id="receipt_header">
		...
		<div id="owners"><?php echo $this->config->item('owners_name'); ?></div>
		<div>NIT:<?php echo $this->config->item('nit'); ?></div>
		<div id="company_address"><?php echo nl2br($this->config->item('address')); ?></div>
		<div id="company_phone"><?php echo $this->config->item('phone'); ?></div>
		
		<div id="sat_resolution_number_and_date"><?php echo $this->config->item('sat_resolution_number_and_date'); ?></div>
		<div id="facturation_range"><?php echo $this->config->item('facturation_range'); ?></div>
		<div id="serial_facturation"><?php echo $this->config->item('serial_facturation'); ?></div>
	...
	<div id="receipt_general_info">
		...
		?>
			...
			<div id="customer"><?php echo lang('common_phone_number').": ".$nit; ?></div>
		<?php
		}
		?>
	...
	?>
		<tr>
		<td style="text-align:center;"><span class='long_name'><?php echo $item['name']; ?></span><span class='short_name'><?php echo character_limiter($item['name'],25); ?></span></td>
