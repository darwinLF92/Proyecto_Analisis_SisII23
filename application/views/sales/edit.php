...
<table id="title_bar">
	<tr>
		...
		<td id="title"><?php echo lang('sales_register')." - ".lang('sales_edit_sale'); ?> Factura No. <?php echo $sale_info['sale_id']; ?></td>
	</tr>
</table>
<br />
...
<div id="edit_sale_wrapper">
	...
	<?php echo form_label(lang('sales_receipt').':', 'sales_receipt'); ?>
		<div class='form_field'>
			<?php echo anchor('sales/receipt/'.$sale_info['sale_id'], 'Factura No. '.$sale_info['sale_id'], array('target' => '_blank'));?>
		</div>
	</div>
